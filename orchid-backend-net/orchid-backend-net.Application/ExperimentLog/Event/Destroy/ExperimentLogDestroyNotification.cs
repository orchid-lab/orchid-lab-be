...
{
    internal class ExperimentLogDestroyNotificationHandler(
        IExperimentLogRepository experimentLogRepository,
        IUserRepository userRepository,
        INotificationRepository notificationRepository,
        INotificationPushService pushService)
        : INotificationHandler<DomainEventNotification<ExperimentLogDestroyed>>
    {
        public async Task Handle(DomainEventNotification<ExperimentLogDestroyed> evt, CancellationToken cancellationToken)
        {
