...
namespace orchid_backend_net.Application.ExperimentLog.UseCase.UpdateExperimentLogInformation
{
    ...
    internal class UpdateExperimentLogInformationCommandHandler(IExperimentLogRepository experimentLogRepository) : IRequestHandler<UpdateExperimentLogInformationCommand, string>
    {
