...
{
    public static class PageResultMappingExtentations
    {
        /// <summary>
        ...
        public static PageResult<TDto> MapToPagedResult<TDomain, TDto>(this IPageResult<TDomain> pagedResult, Func<TDomain, TDto> mapFunc)
        {
            var data = pagedResult.Select(mapFunc).ToList();

            return PageResult<TDto>.Create(
