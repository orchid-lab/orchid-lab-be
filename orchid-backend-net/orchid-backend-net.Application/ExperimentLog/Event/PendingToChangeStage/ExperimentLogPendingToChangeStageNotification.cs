...
{
    public record ExperimentLogPendingToChangeStageNotification(ExperimentLogPendingToChangeStage DomainEvent)
        : INotification;
    ...
    internal class ExperimentLogPendingToChangeStageNotificationHandler(
        ...
        INotificationRepository notificationRepository) : INotificationHandler<ExperimentLogPendingToChangeStageNotification>
    {
        public async Task Handle(ExperimentLogPendingToChangeStageNotification evt, CancellationToken cancellationToken)
        {
